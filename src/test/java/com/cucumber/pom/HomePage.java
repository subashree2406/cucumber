...
private WebElement Product;		//blouse,T-SHIRTS,printed dress
@FindBy(xpath="(//span[text()='Add to cart'])[1]")
private WebElement productaddtocart;
@FindBy(xpath="//span[contains(text(),'Proceed to checkout')]")
private WebElement commonProceedtocheck;

public WebElement getCommonProceedtocheck() {
	return commonProceedtocheck;
}
